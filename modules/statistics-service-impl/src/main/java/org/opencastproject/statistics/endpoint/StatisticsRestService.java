...
public class StatisticsRestService {
  ...
  @Path("views/{episodeID:.+}.json")
  @RestQuery(name = "getAsJson", description = "Returns the views for the given episodeID", returnDescription = "Returns the views JSON document", pathParameters = { @RestParameter(name = "episodeID", isRequired = true, description = "The episode identifier", type = STRING) }, reponses = {
          @RestResponse(responseCode = SC_OK, description = "The episode views.")})
  public Response getEpisodeViews(@PathParam("seriesID") String seriesID) {
  ...
  @GET
  @Produces(MediaType.APPLICATION_JSON)
  @Path("views/{seriesID:.+}.json")
  @RestQuery(name = "getAsJson", description = "Returns the views for the given seriesID", returnDescription = "Returns the views JSON document", pathParameters = { @RestParameter(name = "seriesID", isRequired = true, description = "The series identifier", type = STRING) }, reponses = {
      @RestResponse(responseCode = SC_OK, description = "The series views.")})
  public Response getSeriesViews(@PathParam("seriesID") String seriesID) {
    logger.debug("Series Lookup: {}", seriesID);
    try {
      //TODO
      return null;
  ...
  @GET
  @Produces(MediaType.APPLICATION_JSON)
  @Path("views/{organizationID:.+}.json")
  @RestQuery(name = "getAsJson", description = "Returns the views for the given organizationID", returnDescription = "Returns the views JSON document", pathParameters = { @RestParameter(name = "organizationID", isRequired = true, description = "The organization identifier", type = STRING) }, reponses = {
      @RestResponse(responseCode = SC_OK, description = "The organization views.")})
  public Response getOrganizationViews(@PathParam("seriesID") String seriesID) {
    logger.debug("Series Lookup: {}", seriesID);
    try {
      //TODO
      return null;
